...
if [[ -z $1 || -z $2 ]]; then
    ...
    printf "Possible image processing algorithms are: grayscale, sobel, blur, sepia, grayscale, negative\n";
    exit 1;
fi

if [[ $2 == 'serial' ]]; then
    mpicc main.c libs/grayscale.c libs/sobel.c libs/image.c libs/utility.c libs/negative.c -o build/main_serial -lm -fopenmp
    ./build/main_serial $1 serial $3
    exit 0;
elif [[ $2 == 'omp' ]]; then
    mpicc main.c libs/grayscale.c libs/sobel.c libs/image.c libs/utility.c libs/negative.c -o build/main_omp -lm -fopenmp
